    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnBernolli.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent Bernoulli=new Intent(TheoriticalDistribution.this, com.aksetapps.dataanalyser.Bernoulli.class);
        ...
        btnBinomial.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent Binomial=new Intent(TheoriticalDistribution.this, com.aksetapps.dataanalyser.Binomial.class);
        ...
        btnPoisson.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent Poisson=new Intent(TheoriticalDistribution.this, com.aksetapps.dataanalyser.Poisson.class);
        ...
        btnGeometric.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent Geometric=new Intent(TheoriticalDistribution.this, com.aksetapps.dataanalyser.Geometric.class);
        ...
        btnHyperGeometric.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent HyperGeometric=new Intent(TheoriticalDistribution.this, com.aksetapps.dataanalyser.HyperGeometric.class);
        ...
        btnContinuos.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent Continuos=new Intent(TheoriticalDistribution.this, com.aksetapps.dataanalyser.Continuos.class);
        ...
        btnExponential.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent Exponential=new Intent(TheoriticalDistribution.this, com.aksetapps.dataanalyser.Exponential.class);
        ...
        btnNormal.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent Normal=new Intent(TheoriticalDistribution.this, com.aksetapps.dataanalyser.Normal.class);
        ...
        btnCauchy.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent Cauchy=new Intent(TheoriticalDistribution.this, com.aksetapps.dataanalyser.Cauchy.class);
