    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnKPCC.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent KPCC=new Intent(CorrelationAnalysis.this, com.aksetapps.dataanalyser.KPCC.class);
                startActivity(KPCC);
            }
        });
        ...
        btnPartial.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent Partial=new Intent(CorrelationAnalysis.this,PartialCorrelation.class);
        ...
        btnMultiple.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent Multiple=new Intent(CorrelationAnalysis.this,MultipleCorrelation.class);
